...
const mockPosts: Post[] = [
  ...
  },
  {
    ...
    featuredImage: 'https://images.unsplash.com/photo-1627398242454-45a1465c2479?w=800&h=400&fit=crop&crop=center',
    published: true,
    publishedAt: new Date().toISOString(),
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  },
  {
    ...
    content: 'Explore the latest web design trends that are shaping the digital landscape in 2024.',
    excerpt: 'Explore the latest web design trends that are shaping the digital landscape in 2024.',
  ...
  },
  {
    ...
    content: 'How artificial intelligence is revolutionizing software development and what to expect next.',
    excerpt: 'How artificial intelligence is revolutionizing software development and what to expect next.',
  ...
  },
  {
    ...
    content: 'Essential principles and techniques for creating exceptional user experiences in modern applications.',
    excerpt: 'Essential principles and techniques for creating exceptional user experiences in modern applications.',
